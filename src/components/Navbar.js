...
const pages = ['ADMIN 1', 'ADMIN 2', 'ADMIN 3'];
...
// } 
  ...
  return (
    ...
    {/* const result = (internetCheck) ? "true" : "false";
      ...
      <Container maxWidth="xl">
        ...
        <FullscreenIcon style={{ marginLeft: "6px"}}/>
          ...
          <Search  sx={{display: {xs:"none", sm:"block"}}}>
           ...
           <KeyboardVoiceIcon className="voice mx-6" sx={{display: {xs:"block", sm:"block"}}}/>
